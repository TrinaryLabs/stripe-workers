    ...
    describe('VerificationReport Resource', async () => {
        describe('retrieve', async () => {
            it('Sends the correct request', async () => {
                const data = await stripe.identity.verificationReports.retrieve('vr_1Iqe8i2eZvKYlo2CHa5PuTcK')
        ...
        describe('list', async () => {
            it('Sends the correct request', async () => {
                const data = await stripe.identity.verificationReports.list({limit: 10})
