export declare namespace transfers {
    ...
    function createReversal(id: string, params: {
        amount: number;
        description?: string;
        metadata?: [string, unknown];
        refund_application_fee?: boolean;
    }, stripeAccount?: string): Promise<unknown>;
    function retrieveReversal(id: string, rever_id: string, stripeAccount?: string): Promise<unknown>;
    function updateReversal(id: string, rever_id: string, params: {
        metadata?: [string, unknown];
    }, stripeAccount?: string): Promise<unknown>;
    function listReversals(id: string, params: {
        ending_before?: string;
        limit?: number;
        starting_after?: string;
    }, stripeAccount?: string): Promise<unknown>;
