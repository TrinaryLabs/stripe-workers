export namespace subscriptions {
    ...
    export function create(
        ...
        return client(`/subscriptions`, params, 'POST', stripeAccount
    ...
    export function retrieve(
        ...
        return client(`/subscriptions/${id}`, {}, 'GET', stripeAccount
        ? { 'Stripe-Account': stripeAccount }
        : {},)
    }
    ...
    export function update(
        ...
        return client(`/subscriptions/${id}`, params, 'POST', stripeAccount
        ? { 'Stripe-Account': stripeAccount }
        : {},)
    }
    ...
    export function del(
        ...
        return client(`/subscriptions/${id}`, params, 'DELETE', stripeAccount
        ? { 'Stripe-Account': stripeAccount }
        : {},)
    }
    ...
    export function list(
        ...
        /* return client(`/subscriptions`, params, 'GET', stripeAccount
        ? { 'Stripe-Account': stripeAccount }
        : {},)*/
    }
    ...
    export function deleteDiscount(
        ...
        return client(`/subscriptions/${id}/discount`, {}, 'DELETE', stripeAccount
        ? { 'Stripe-Account': stripeAccount }
        : {},)
    }
}