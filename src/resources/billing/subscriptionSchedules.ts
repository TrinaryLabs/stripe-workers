export namespace subscriptionSchedules {
    ...
    export function create(
        ...
        return client(`/subscription_schedules`, params, 'POST', stripeAccount
    ...
    export function retrieve(
        ...
        return client(`/subscription_schedules/${id}`, {}, 'GET', stripeAccount
        ? { 'Stripe-Account': stripeAccount }
        : {},)
    }
    ...
    export function cancel(
        ...
        return client(`/subscription_schedules/${id}/cancel`, params, 'POST', stripeAccount
        ? { 'Stripe-Account': stripeAccount }
        : {},)
    }
    ...
    export function release(
        ...
        return client(`/subscription_schedules/${id}/release`, params, 'POST', stripeAccount
        ? { 'Stripe-Account': stripeAccount }
        : {},)
    }
